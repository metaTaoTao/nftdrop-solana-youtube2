...
export default function Main() {
  ...
  const [candyStateError, setCandyStatError] = useState();
  ...
  return (
    <div className={styles.wrapper}>
      ...
      />
      <Head>
        <title>Home | Solana Millionaire Bear NFT</title>
      </Head>
      ...
      <div className={styles.container}>
        <section className={styles.infoSection}>
          ...
          <div>
            ...
            {candyStateLoading ? (<div>Loading</div>) : 
             candyStateError? (<div>{candyStateError}</div>) : 
             (candyState && (
              <div>
